...
EPOCHS = 20          # RetinaNet is heavier, so 20 is acceptable
BATCH_SIZE = 1       # prevents CUDA out-of-memory
LR = 0.0001
...
for epoch in range(1, EPOCHS + 1):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), ROOT / "retinanet_battery_best.pth")
        print("Saved best RetinaNet model")
...
# SAVE RESULTS
# =========================
pd.DataFrame(history).to_csv(ROOT / "retinanet_training_results.csv", index=False)

print("\nRetinaNet training complete.")
print("Best model saved as:", ROOT / "retinanet_battery_best.pth")
print("Results saved as:", ROOT / "retinanet_training_results.csv")